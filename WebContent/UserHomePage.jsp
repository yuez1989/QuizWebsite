...
<script type="text/javascript" src="bg-switcher/Source/js/jquery.bcat.bgswitcher.js"></script>
<link type="text/css" rel="stylesheet" href="bg-switcher/Source/css/style.css" media="all" />
</head>
<title>Quizzzz <%
		...
		<div class="uhp-content">
			...
			<div class="uhp-others col-md-3">
				...
				<div>
					...
					%>
					<p style='padding-left: 5px;'><%=s%></p>
					<%
						}
							} else {
					%>
					<p style='padding-left: 5px;'>No Announcement</p>
					<%
						}
						} else {
					%>
				...
				<div>
					<div>Recently Created Quizzes (in Public)</div>
					<%
